...
const TeamStats: React.FC = () => {
  ...
  const playerAggregates = players.map(player => {
    ...
    const agg = pStats.reduce((acc, curr) => ({
      // FIX: The `minutes` property is a number. Sum it directly instead of calling parseMinutes.
